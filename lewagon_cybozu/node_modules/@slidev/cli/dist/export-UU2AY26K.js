...
async function exportSlides({
  ...
  if (!_chunkZO3WYQGQjs.packageExists.call(void 0, "playwright-chromium"))
    throw new Error("The exporting for Slidev is powered by Playwright, please installed it via `npm i playwright-chromium`");
  const {chromium} = await Promise.resolve().then(() => _chunkPEXO6EK5js.__toModule.call(void 0, _chunkPEXO6EK5js.__require.call(void 0, "playwright-chromium")));
  ...
  async function go(no) {
    progress.update(no);
    const url = routerMode === "hash" ? `http://localhost:${port}/#${base}${no}?print` : `http://localhost:${port}${base}${no}?print`;
    await page.goto(url, {
