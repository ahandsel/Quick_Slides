import {
  createServer
} from "./chunk-Y7PQA6ZZ.mjs";
import {
  require_fast_deep_equal
} from "./chunk-OTGWKASD.mjs";
import {
  getThemeRoots,
  isPath,
  resolveOptions,
...
cli.command("build [entry]", "Build hostable SPA", (args) => commonOptions(args).option("watch", {
  ...
  const {build} = await Promise.resolve().then(() => __toModule(__require("./build-4FZFZS4I.mjs")));
...
cli.command("export [entry]", "Export slides to PDF", (args) => commonOptions(args).option("output", {
  ...
  const {exportSlides} = await Promise.resolve().then(() => __toModule(__require("./export-UXI4B6E7.mjs")));
