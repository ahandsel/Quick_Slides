...
var require_fast_deep_equal = _chunkPEXO6EK5js.__commonJS.call(void 0, {
...
<link href="https://fonts.googleapis.com/css2?${fonts}&display=swap" rel="stylesheet">`;
  ...
  main = main.replace("__ENTRY__", _chunkPEXO6EK5js.toAtFS.call(void 0, _path.join.call(void 0, clientRoot, "main.ts"))).replace("<!-- head -->", head).replace("<!-- body -->", body);
  return main;
}
...
function deepMerge(a, b, rootPath = "") {
  a = _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, a);
...
async function createWindiCSSPlugin({themeRoots, clientRoot, userRoot, roots, data}, {windicss: windiOptions}) {
  ...
  return _vitepluginwindicss2.default.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {
    ...
    onOptionsResolved(config2) {
      ...
      config2.scanOptions.exclude.push(_path.dirname.call(void 0, _chunkPEXO6EK5js.resolveImportPath.call(void 0, "monaco-editor/package.json", true)));
      config2.scanOptions.exclude.push(_path.dirname.call(void 0, _chunkPEXO6EK5js.resolveImportPath.call(void 0, "katex/package.json", true)));
      config2.scanOptions.exclude.push(_path.dirname.call(void 0, _chunkPEXO6EK5js.resolveImportPath.call(void 0, "prettier/package.json", true)));
    }
  }, windiOptions), {
    hookOptions: {
...
function createConfigPlugin(options) {
  return {
    ...
    config(config) {
      const injection = {
        define: {
          __SLIDEV_CLIENT_ROOT__: JSON.stringify(_chunkPEXO6EK5js.toAtFS.call(void 0, options.clientRoot)),
          __SLIDEV_HASH_ROUTE__: options.data.config.routerMode === "hash",
          __DEV__: options.mode === "dev" ? "true" : "false"
        },
        resolve: {
          alias: {
            "@slidev/client/": `${_chunkPEXO6EK5js.toAtFS.call(void 0, options.clientRoot)}/`
          }
        },
        optimizeDeps: {
          include: [
      ...
      if (_isinstalledglobally2.default) {
        ...
        injection.resolve.alias.vue = `${_chunkPEXO6EK5js.resolveImportPath.call(void 0, "vue/dist/vue.esm-browser.js", true)}`;
      }
...
var import_fast_deep_equal = _chunkPEXO6EK5js.__toModule.call(void 0, require_fast_deep_equal());
...
function prepareSlideInfo(data) {
  return _chunkPEXO6EK5js.__spreadProps.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, data), {
    notesHTML: md.render((data == null ? void 0 : data.note) || "")
  });
}
function createSlidesLoader({data, entry, clientRoot, themeRoots, userRoot, roots}, pluginOptions, VuePlugin, MarkdownPlugin) {
      ...
      async handleHotUpdate(ctx) {
        ...
        const vueModules = (await Promise.all(Array.from(hmrPages).map(async (i) => {
          ...
          try {
            ...
            return await VuePlugin.handleHotUpdate(_chunkPEXO6EK5js.__spreadProps.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, ctx), {
  ...
  async function transformMarkdown(code, pageNo, data2) {
    ...
    const frontmatter = _chunkPEXO6EK5js.__spreadValues.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, ((_a = data2.headmatter) == null ? void 0 : _a.defaults) || {}), ((_b = data2.slides[pageNo]) == null ? void 0 : _b.frontmatter) || {});
    const layoutName = (frontmatter == null ? void 0 : frontmatter.layout) || (pageNo === 0 ? "cover" : "default");
    if (!layouts[layoutName])
      throw new Error(`Unknown layout "${layoutName}"`);
    const imports = [
      `import InjectedLayout from "${_chunkPEXO6EK5js.toAtFS.call(void 0, layouts[layoutName])}"`,
...
${code.slice(injectB)}`;
  ...
  async function generateUserStyles() {
    const imports = [
      `import "${_chunkPEXO6EK5js.toAtFS.call(void 0, _path.join.call(void 0, clientRoot, "styles/vars.css"))}"`,
      `import "${_chunkPEXO6EK5js.toAtFS.call(void 0, _path.join.call(void 0, clientRoot, "styles/index.css"))}"`,
      `import "${_chunkPEXO6EK5js.toAtFS.call(void 0, _path.join.call(void 0, clientRoot, "styles/code.css"))}"`
    ];
    const roots2 = _utils.uniq.call(void 0, [
      ...themeRoots,
      userRoot
    ...
    for (const root of roots2) {
      ...
      for (const style of styles) {
        if (_fsextra.existsSync.call(void 0, style)) {
          imports.push(`import "${_chunkPEXO6EK5js.toAtFS.call(void 0, style)}"`);
          continue;
        }
      }
    }
    if (data.features.katex)
      imports.push(`import "${_chunkPEXO6EK5js.toAtFS.call(void 0, _chunkPEXO6EK5js.resolveImportPath.call(void 0, "katex/dist/katex.min.css", true))}"`);
    return imports.join("\n");
  }
  ...
  async function generateLayouts() {
    ...
    const layouts = _utils.objectMap.call(void 0, await getLayouts(), (k, v) => {
      imports.push(`import __layout_${k} from "${_chunkPEXO6EK5js.toAtFS.call(void 0, v)}"`);
...
${routes.join(",\n")}
  ...
  function generateConfigs() {
    const config = _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, data.config);
    if (_utils.isString.call(void 0, config.title)) {
      const tokens = md.parseInline(config.title, {});
      config.title = _chunkPEXO6EK5js.stringifyMarkdownTokens.call(void 0, tokens);
    }
  ...
  async function generateGlobalComponents(layer) {
    ...
    const imports = components.map((i, idx) => `import __n${idx} from '${_chunkPEXO6EK5js.toAtFS.call(void 0, i)}'`).join("\n");
    ...
    async transform(code, id) {
      if (id.startsWith(setupEntry)) {
        ...
        setups.forEach((path, idx) => {
          if (!_fs.existsSync.call(void 0, path))
            return;
          imports.push(`import __n${idx} from '${_chunkPEXO6EK5js.toAtFS.call(void 0, path)}'`);
          let fn = `__n${idx}`;
...
function loadPrismPlugin(name) {
  try {
    _chunkPEXO6EK5js.__require.call(void 0, `prismjs/plugins/${name}/prism-${name}`);
  } catch (e) {
...
function resolveShikiOptions(options) {
  ...
  return _chunkPEXO6EK5js.__spreadProps.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, options), {
    themes,
...
async function createMarkdownPlugin({data: {config}, roots, mode, entry}, {markdown: mdOptions}) {
  ...
  if (config.highlighter === "shiki") {
    const {getHighlighter} = await Promise.resolve().then(() => _chunkPEXO6EK5js.__toModule.call(void 0, _chunkPEXO6EK5js.__require.call(void 0, "shiki")));
  ...
  return _vitepluginmd2.default.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {
    wrapperClasses: "",
    headEnabled: false,
    frontmatter: false,
    markdownItOptions: {
...
async function ViteSlidevPlugin(options, pluginOptions) {
  ...
  const VuePlugin = _pluginvue2.default.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {
    include: [/\.vue$/, /\.md$/],
    exclude: [],
    template: {
      compilerOptions: {
  ...
  return [
    ...
    _viteplugincomponents2.default.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {
    ...
    _vitepluginicons2.default.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {}, iconsOptions)),
    config.remoteAssets === true || config.remoteAssets === mode ? _vitepluginremoteassets2.default.call(void 0, _chunkPEXO6EK5js.__spreadValues.call(void 0, {
      rules: [
