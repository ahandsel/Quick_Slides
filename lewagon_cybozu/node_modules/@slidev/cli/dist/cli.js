...
var _chunkA5XP5JO3js = require('./chunk-A5XP5JO3.js');


var _chunkLUEQIH7Ujs = require('./chunk-LUEQIH7U.js');
...
var _chunkZO3WYQGQjs = require('./chunk-ZO3WYQGQ.js');
...
// node/cli.ts
var import_fast_deep_equal = _chunkPEXO6EK5js.__toModule.call(void 0, _chunkLUEQIH7Ujs.require_fast_deep_equal.call(void 0, ));
...
var cli = _yargs2.default.scriptName("slidev").usage("$0 [args]").version(_chunkZO3WYQGQjs.version).strict().showHelpOnFail(false).alias("h", "help").alias("v", "version");
cli.command("* [entry]", "Start a local server for Slidev", (args) => commonOptions(args).option("port", {
  ...
  async function initServer() {
    if (server)
      await server.close();
    const options = await _chunkZO3WYQGQjs.resolveOptions.call(void 0, {entry, theme}, "dev");
    port = userPort || await findFreePort(3030);
    server = await _chunkA5XP5JO3js.createServer.call(void 0, options, {
      onDataReload(newData, data) {
        if (!theme && _chunkZO3WYQGQjs.resolveThemeName.call(void 0, newData.config.theme) !== _chunkZO3WYQGQjs.resolveThemeName.call(void 0, data.config.theme)) {
...
cli.command("build [entry]", "Build hostable SPA", (args) => commonOptions(args).option("watch", {
  ...
  const {build} = await Promise.resolve().then(() => _chunkPEXO6EK5js.__toModule.call(void 0, _chunkPEXO6EK5js.__require.call(void 0, "./build-NPTQ5WO7.js")));
  const options = await _chunkZO3WYQGQjs.resolveOptions.call(void 0, {entry, theme}, "build");
...
cli.command("theme [subcommand]", "Theme related operations", (command) => {
  return command.command("eject", "Eject current theme into local file system", (args) => commonOptions(args).option("dir", {
    ...
    const data = await _fs.load.call(void 0, entry);
    const theme = _chunkZO3WYQGQjs.resolveThemeName.call(void 0, themeInput || data.config.theme);
    if (theme === "none") {
      console.error('Can not eject theme "none"');
      process.exit(1);
    }
    if (_chunkZO3WYQGQjs.isPath.call(void 0, theme)) {
      console.error("Theme is already ejected");
      process.exit(1);
    }
    const roots = _chunkZO3WYQGQjs.getThemeRoots.call(void 0, theme, entry);
    if (!roots.length) {
...
cli.command("export [entry]", "Export slides to PDF", (args) => commonOptions(args).option("output", {
  ...
  const {exportSlides} = await Promise.resolve().then(() => _chunkPEXO6EK5js.__toModule.call(void 0, _chunkPEXO6EK5js.__require.call(void 0, "./export-UU2AY26K.js")));
  const port = await findFreePort(12445);
  const options = await _chunkZO3WYQGQjs.resolveOptions.call(void 0, {entry, theme}, "build");
  const server = await _chunkA5XP5JO3js.createServer.call(void 0, options, {}, {
    server: {port},
    logLevel: "error",
    clearScreen: false
  });
...
function printInfo(options, port, remote) {
  ...
  console.log(`${_kolorist.bold.call(void 0, "  Slidev")}  ${_kolorist.blue.call(void 0, `v${_chunkZO3WYQGQjs.version}`)} ${_isinstalledglobally2.default ? _kolorist.yellow.call(void 0, "(global)") : ""}`);
  console.log();
