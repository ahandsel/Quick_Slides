import { SlidevMarkdown, SlideInfoBase, SlidevFeatureFlags, SlidevThemeMeta, SlidevConfig } from '@slidev/types';
...
export { detectFeatures, filterDisabled, mergeFeatureFlags, parse, parseAspectRatio, parseRangeString, parseSlide, prettify, prettifySlide, resolveConfig, scanMonacoModules, stringify, stringifySlide };
