...
// ../../node_modules/.pnpm/@antfu+utils@0.1.6/node_modules/@antfu/utils/dist/index.js
var require_dist = __commonJS({
  "../../node_modules/.pnpm/@antfu+utils@0.1.6/node_modules/@antfu/utils/dist/index.js"(exports) {
    "use strict";
...
function mergeFeatureFlags(a, b) {
  return (0, import_utils2.objectMap)(a, (k, v) => [k, v || b[k]]);
}
function scanMonacoModules(md) {
  ...
  md.replace(/^```(\w+?)\s*{monaco([\w:,-]*)}[\s\n]*([\s\S]+?)^```/mg, (full, lang = "ts", options, code) => {
    ...
    if (lang === "ts" || lang === "typescript") {
      Array.from(code.matchAll(/\s+from\s+(["'])([\/\w@-]+)\1/g)).map((i) => i[2]).filter(import_utils2.isTruthy).map((i) => typeModules.add(i));
    }
    return "";
  });
...
exports.__spreadValues = __spreadValues; exports.parseRangeString = parseRangeString; exports.parseAspectRatio = parseAspectRatio; exports.stringify = stringify; exports.filterDisabled = filterDisabled; exports.stringifySlide = stringifySlide; exports.prettifySlide = prettifySlide; exports.prettify = prettify; exports.detectFeatures = detectFeatures; exports.parseSlide = parseSlide; exports.parse = parse; exports.resolveConfig = resolveConfig; exports.mergeFeatureFlags = mergeFeatureFlags; exports.scanMonacoModules = scanMonacoModules;
